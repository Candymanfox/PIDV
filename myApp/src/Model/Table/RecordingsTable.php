 ...
 * @property \App\Model\Table\UsersPreferredTitlesTable|\Cake\ORM\Association\HasMany $UsersPreferredTitles
 *
...
class RecordingsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('mb_recordingid')
            ->requirePresence('mb_recordingid', 'create')
            ->notEmpty('mb_recordingid');
    ...
    {
        $rules->add($rules->existsIn(['artists_id'], 'Artists'));
